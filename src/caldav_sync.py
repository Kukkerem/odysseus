                    ...
                    for obj in objs:
                        ...
                        for comp in ical.walk():
                            ...
                            if existing:
                                ...
                                # account that also sees it). uid is the global
                                # PK, so we cannot insert a second copy; doing so
                                # raises IntegrityError on commit, which is
                                # caught only per-calendar and rolls back every
                                # event in this calendar. Skip the duplicate.
